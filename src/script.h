...
#ifndef H_bullyon_SCRIPT
#define H_bullyon_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CbullyonAddress
 */
...
public:
    ...
    // Pre-version-0.6, bullyon always counted CHECKMULTISIGs
