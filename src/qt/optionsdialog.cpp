    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new bullyonUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->bullyonAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting bullyon."), QMessageBox::Ok);
